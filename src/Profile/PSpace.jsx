...
export default function PSpace() {
  const linksArray = [
...

    {
      ...
      id: "book__design",
      title:
        "This is a free Design books from Zuri. At Zuri, we care about good design and we are happy to help with your design",
    },
  ];
  ...
  return (
    <div className="pSpace">
      ...
      <div className="links">
        ...
        <Link to="/contact" className="training" id="contact">
          Contact
        </Link>
      </div>
      ...
      <div className="nav">
        <div className="icons">
          <div className="slack">
            <a href="https://app.slack.com" target="_blank" rel="noreferrer">
              {" "}
              <img src={slack} alt="" />{" "}
            </a>
          </div>
          <a href="https://github.com/Jejeet" target="_blank" rel="noreferrer">
            <img src={github} alt="" />
          </a>
        </div>
      </div>
